...
/**
 * GitHub mark. Lucide dropped brand icons, so we ship the official mark inline.
 * Inherits `currentColor` and sizes via the `[&_svg]:size-4` rule on Button.
 */
